...
if (!isset($_SESSION['username_restaurant_qRewacvAqzA']) || 
    !isset($_SESSION['role_restaurant_qRewacvAqzA']) || 
...
<!-- TOP 4 CARDS -->
<div class="row">
    <?php if ($_SESSION['role_restaurant_qRewacvAqzA'] === 'admin') { ?>
        ...
        <div class='responsive-table'>
            ...
            <table class="table X-table tabcontent_orders" id="recent_orders" style="display:table">
                ...
                <tbody>
                    ...
                    if ($count == 0) {
                        echo "<tr><td colspan='5' style='text-align:center;'>List of your recent orders will be presented here</td></tr>";
                    } else {
            ...
            <table class="table X-table tabcontent_orders" id="completed_orders">
                ...
                <tbody>
                    ...
                    if ($count == 0) {
                        echo "<tr><td colspan='5' style='text-align:center;'>List of your completed orders will be presented here</td></tr>";
                    } else {
                        foreach ($rows as $row) {
                            echo "<tr>";
            ...
            <table class="table X-table tabcontent_orders" id="canceled_orders">
                ...
                <tbody>
                    ...
                    $count = $stmt->rowCount();
                    if ($count == 0) {
                        echo "<tr><td colspan='5' style='text-align:center;'>List of your canceled orders will be presented here</td></tr>";
                    } else {
                        foreach ($rows as $row) {
                            echo "<tr>";
                            echo "<td>" . $row['order_time'] . "</td>";
    ...
    <div class="card-body">
        <div class='responsive-table'>
            ...
            <table class="table X-table tabcontent_reservations" id="recent_reservations" style="display:table">
                <thead>
                    <tr>
                        <th>Reservation Time Created</th>
                ...
                <tbody>
                    ...
                    if ($count == 0) {
                        echo "<tr><td colspan='5' style='text-align:center;'>List of your upcoming reservations will be presented here</td></tr>";
                    } else {
            ...
            <table class="table X-table tabcontent_reservations" id="completed_reservations">
                ...
                <tbody>
                    ...
                    if ($count == 0) {
                        echo "<tr><td colspan='5' style='text-align:center;'>List of your completed reservations will be presented here</td></tr>";
                    } else {
                        foreach ($rows as $row) {
                            echo "<tr>";
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.error) {
                    ...
                    swal("Table Liberated", "The table has been marked as free", "success").then((value) => {
                        window.location.replace("dashboard.php");
                    });
                }
            },
